...
import br.com.projeto_cnh.CTR.BackupCTR;
...
public class PrincipalVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JMenuItem mntmNewMenuItem = new JMenuItem("Criar Backup");
        ...
        JMenuItem mntmNewMenuItem_1 = new JMenuItem("Carregar Backup");
        ...
        JMenuItem mntmNewMenuItem_2 = new JMenuItem("Relatório Clientes");
        mntmNewMenuItem_2.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		abreRelatorioClienteVIEW();
        	}
        });
        mnNewMenu_1.add(mntmNewMenuItem_2);
        
        JMenuItem mntmNewMenuItem_3 = new JMenuItem("Relatório Instrutor-Veiculo");
        mntmNewMenuItem_3.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		abreRelatorioInstrutorVeiculoVIEW();
        	}
        });
    ...
    private void abreRelatorioClienteVIEW() {
        RelatorioClienteVIEW  relatorioClienteVIEW = new  RelatorioClienteVIEW();
        this.desktopPane.add(relatorioClienteVIEW);
        relatorioClienteVIEW.setVisible(true);
        relatorioClienteVIEW.setPosition();
        
    }
    
    private void abreRelatorioInstrutorVeiculoVIEW() {
        RelatorioInstrutorVeiculoVIEW  relatorioInstrutorVeiculoVIEW = new  RelatorioInstrutorVeiculoVIEW();
        this.desktopPane.add(relatorioInstrutorVeiculoVIEW);
        relatorioInstrutorVeiculoVIEW.setVisible(true);
        relatorioInstrutorVeiculoVIEW.setPosition();
    ...
    static javax.swing.JMenu menuCadastro;
    static javax.swing.JMenuItem menuCliente;
    static javax.swing.JMenuItem menuInstrutor;
    static javax.swing.JMenu menuSair;
    static javax.swing.JMenuItem menuVeiculo;
